    ...
    local settingsConfig = {
        {
            ...
            settings = {
                { name = "Hide Common Text", key = "HIDE_UNWANTED_TEXT", type = "boolean", 
                  tooltip = "Hide common item text like 'Soulbound' and 'Unique' from keystone tooltips." },
                { name = "Hide Affix Text", key = "HIDE_AFFIX_TEXT", type = "boolean", 
                  tooltip = "Hide the lines listing the current dungeon affixes." },
                { name = "Hide Duration Text", key = "HIDE_DURATION", type = "boolean", 
                  tooltip = "Hide the duration line from keystone tooltips." },
                { name = "Level Display Style", key = "LEVEL_DISPLAY", type = "string", 
                  tooltip = TOOLTIPS.LEVEL_DISPLAY, options = DROPDOWN_OPTIONS.LEVEL_DISPLAY },
        ...
        },
        {
            ...
            settings = {
                { name = "Show Score Timing Bonus", key = "SHOW_TIMING", type = "boolean", 
                  tooltip = "Show the potential timing bonus (0-15)." },
                { name = "Timer Display", key = "TIMER_DISPLAY_MODE", type = "string", 
                  tooltip = TOOLTIPS.TIMER_DISPLAY_MODE, options = DROPDOWN_OPTIONS.TIMER_DISPLAY_MODE },
                { name = "Player Best Display", key = "PLAYER_BEST_DISPLAY", type = "string", 
                  tooltip = TOOLTIPS.PLAYER_BEST_DISPLAY, options = DROPDOWN_OPTIONS.PLAYER_BEST_DISPLAY },
                { name = "Remove Score Colors", key = "PLAIN_SCORE_COLORS", type = "boolean", 
